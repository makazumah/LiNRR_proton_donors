...
molecule_paths = ["/home/vazumah/Python_projects/LiNRR/Li_adsorb_studies/pure_structures_results/neutral_molecules/N2/relax.traj"] # Enter the path for the molecule to calc DOS for
